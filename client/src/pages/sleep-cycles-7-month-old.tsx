...
export default function SleepCycles7MonthOldPage() {
  useEffect(() => {
    window.scrollTo(0, 0);
    document.title = "7-Month Old Sleep Patterns - SleepCycle.io";

    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Understanding 7-month old sleep patterns, schedules, and development. Calculate optimal sleep times using our sleep cycle calculator.');
    }
  }, []);
      ...
      <main className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="text-center mb-12">
          <div className="flex justify-center items-center mb-6">
            <Baby className="text-orange-500 mr-3" size={48} />
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900">
              7-Month Old Sleep Patterns
            </h1>
          </div>
        ...
        <div className="mb-16">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Use our calculator to optimize sleep timing for your 7-month-old
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          <Card className="bg-white hover:shadow-lg transition-shadow duration-200">
            ...
            <CardContent>
              <p className="text-gray-600 text-sm leading-relaxed">
                At 7 months, babies need 12-15 hours of sleep per day. This includes
          ...
          <Card className="bg-white hover:shadow-lg transition-shadow duration-200">
            ...
            <CardContent>
              <p className="text-gray-600 text-sm leading-relaxed">
                Sleep cycles are well-established at 60-90 minutes. Babies have
                consolidated nighttime sleep with predictable patterns.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white hover:shadow-lg transition-shadow duration-200">
            ...
            <CardContent>
              <p className="text-gray-600 text-sm leading-relaxed">
                Babies may experience separation anxiety and increased mobility.
                Consistent routines help maintain good sleep habits.
              </p>
            </CardContent>
          </Card>
        </div>
          ...
          <CardContent className="p-6">
            <div className="space-y-3">
              <div className="flex justify-between items-center p-3 bg-orange-50 rounded-lg">
                ...
                <span className="text-orange-600 font-semibold">6:00 - 7:00 AM</span>
              </div>
              <div className="flex justify-between items-center p-3 bg-blue-50 rounded-lg">
                <span className="font-medium text-gray-900">First Nap</span>
                <span className="text-blue-600 font-semibold">9:30 - 11:00 AM</span>
              </div>
        ...
        <Card className="bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200">
          <CardHeader className="pb-3">
            <CardTitle className="text-lg font-semibold text-gray-900">
              Tips for 7-Month Sleep Success
            </CardTitle>
          </CardHeader>
          <CardContent>
            <ul className="space-y-2 text-sm text-gray-700">
              <li className="flex items-start">
                ...
                Focus on wake windows: 2.5-3.5 hours between sleep periods
              </li>
              <li className="flex items-start">
                <span className="text-blue-600 mr-2">•</span>
              ...
              <li className="flex items-start">
                <span className="text-blue-600 mr-2">•</span>
                Address separation anxiety with comforting bedtime routines
              </li>
              <li className="flex items-start">
                <span className="text-blue-600 mr-2">•</span>
                Continue creating a sleep-conducive environment
              </li>
              <li className="flex items-start">
                <span className="text-blue-600 mr-2">•</span>
