...
import SleepResults from './sleep-results';
import { TimeState, CalculatorMode, CycleResult } from '@/types/calculator';
import { FALL_ASLEEP_MINUTES, SLEEP_CYCLE_MINUTES } from '@/constants/calculator';
import { Moon, Sun, ArrowRight, BedDouble, Info } from 'lucide-react';

export function DarkSleepCalculator() {
