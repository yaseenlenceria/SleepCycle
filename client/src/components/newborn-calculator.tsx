        ...
        <div className="bg-white rounded-xl shadow-md border-2 border-pink-200 p-4 sm:p-6 inline-block max-w-full">
          <div className="flex justify-center items-center gap-2 sm:gap-3">
            ...
            <select
              ...
              className="text-3xl sm:text-4xl md:text-5xl font-bold border-2 border-pink-300 rounded-lg px-3 sm:px-4 py-3 sm:py-4 bg-white focus:border-pink-500 focus:outline-none w-20 sm:w-24 md:w-28 text-center pl-[3px] pr-[3px]"
